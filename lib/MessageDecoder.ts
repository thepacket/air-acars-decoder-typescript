...
const pluginClasses = [
  ...
  Plugins.Label_QR,
  Plugins.Label_QS,
  Plugins.Label_4P_PDC,
  Plugins.Label_4R_ACA,
  Plugins.Label_4S_ACA_Maint,
  Plugins.Label_40_FlightProgress,
  Plugins.Label_RA,
  Plugins.Label_32_Skywest,
  Plugins.Label_27_POS,
  Plugins.Label_A4_FSM,
  Plugins.Label_3P_POSN,
  Plugins.Label_26_CompactSingleLine,
  Plugins.Label_37_Obfuscated,
];
